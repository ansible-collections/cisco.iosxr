...
class TestIosxrNtpGlobalModule(TestIosxrModule):
        ...
        set_module_args(
            dict(
                config=dict(
                    ...
                    source="GigabitEthernet0/0/0/0",
                    source_vrfs=[
                        dict(name="GigabitEthernet0/0/0/0",
                             vrf="siteE")
                    ],
                    trusted_keys=[
                        dict(key_id=1,),
    ...
    def test_iosxr_ntp_global_gathered(self):
        ...
        gathered = {'max_associations': 10, 'interfaces': [{'vrf': 'siteB', 'name': 'GigabitEthernet0/0/0/0', 'multicast_key': 1}, {'name': 'GigabitEthernet0/0/0/0', 'broadcast_client': True, 'multicast_client': '224.0.0.8', 'multicast_destination': '224.0.0.8'}], 'authentication_keys': [{'id': 1, 'key': 'testkey', 'encryption': True}, {'id': 2, 'key': '071B245F5A5B', 'encryption': True}], 'authenticate': True, 'trusted_keys': [{'key_id': 1}, {'key_id': 2}], 'ipv4': {'dscp': 'af11'}, 'ipv6': {'precedence': 'routine'}, 'peers': [{'peer': '192.0.2.1', 'vrf': 'siteC', 'iburst': True}], 'servers': [{'server': '192.0.2.2', 'vrf': 'siteD', 'burst': True}, {'server': '192.0.2.2', 'burst': True, 'iburst': True, 'key': 1, 'minpoll': 4, 'maxpoll': 5, 'prefer': True, 'version': 2, 'source': 'GigabitEthernet0/0/0/0'}], 'drift': {'file': 'apphost', 'aging_time': 0}, 'master': 1, 'access_group': {'vrfs': [{'name': 'siteA', 'ipv4': {'peer': 'PeerAcl3', 'serve': 'ServeAcl2'}}], 'ipv4': {'peer': 'PeerAcl1', 'serve': 'ServeAcl1', 'serve_only': 'ServeOnlyAcl1', 'query_only': 'QueryOnlyAcl1'}, 'ipv6': {'peer': 'PeerAcl2'}}, 'source_vrfs': [{'name': 'GigabitEthernet0/0/0/0', 'vrf': 'siteE'}], 'source': 'GigabitEthernet0/0/0/0', 'passive': True, 'broadcastdelay': 1, 'update_calendar': True, 'log_internal_sync': True}
        result = self.execute_module(changed=False)
    ...
    def test_iosxr_ntp_global_parsed(self):
        ...
        result = self.execute_module(changed=False)
        parsed_list = {'max_associations': 10, 'interfaces': [{'vrf': 'siteB', 'name': 'GigabitEthernet0/0/0/0', 'multicast_key': 1}, {'name': 'GigabitEthernet0/0/0/0', 'broadcast_client': True, 'multicast_client': '224.0.0.8', 'multicast_destination': '224.0.0.8'}], 'authentication_keys': [{'id': 1, 'key': 'testkey', 'encryption': True}, {'id': 2, 'key': '071B245F5A5B', 'encryption': True}], 'authenticate': True, 'trusted_keys': [{'key_id': 1}, {'key_id': 2}], 'ipv4': {'dscp': 'af11'}, 'ipv6': {'precedence': 'routine'}, 'peers': [{'peer': '192.0.2.1', 'vrf': 'siteC', 'iburst': True}], 'servers': [{'server': '192.0.2.2', 'vrf': 'siteD', 'burst': True}, {'server': '192.0.2.2', 'burst': True, 'iburst': True, 'key': 1, 'minpoll': 4, 'maxpoll': 5, 'prefer': True, 'version': 2, 'source': 'GigabitEthernet0/0/0/0'}], 'drift': {'file': 'apphost', 'aging_time': 0}, 'master': 1, 'access_group': {'vrfs': [{'name': 'siteA', 'ipv4': {'peer': 'PeerAcl3'}}], 'ipv4': {'peer': 'PeerAcl1', 'serve': 'ServeAcl1', 'serve_only': 'ServeOnlyAcl1', 'query_only': 'QueryOnlyAcl1'}, 'ipv6': {'peer': 'PeerAcl2'}}, 'source_vrfs': [{'name': 'GigabitEthernet0/0/0/0', 'vrf': 'siteE'}], 'source': 'GigabitEthernet0/0/0/0', 'passive': True, 'broadcastdelay': 1, 'update_calendar': True, 'log_internal_sync': True}
